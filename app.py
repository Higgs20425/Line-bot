...
def responese(msg):
    ...
    '媽媽桑': ['要來我家看貓嗎?', '哪個渣男?'],'靠北': ['嗯?', '嘿?', '出事了阿北?'], '告北': ['嗯?', '嘿?', '出事了阿北?'], '不是阿': ['嗯?', '嘿?'], '很快': '有小業快?', '很快餒': '有小業快?', '快喔': '諭哥準備交割?', 
    ...
    '等等': ['麻吉得', '等殺小', '進棺材等?'], '股票':[ '台積電沒在賣的啦', '這裡不談史塔克'], '買哪': [ '跌了你也不敢買', '麗臺 @江忠諭', '長榮 @江忠諭'], '狗狗': ['to the moon', '@林老闆'], '推薦': '問越南小哥?'
    'will': ['大家好 我是will', '歡迎來到X調查'],
    }
